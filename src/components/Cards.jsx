    ...
    <div className='w-full py-[10rem] px-4 bg-white'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                ...
                <button className='bg-[#00df9a] text-white rounded-md w-[200px] text-center mx-auto px-6 py-3 my-6 font-medium'>Start Trial</button>
            </div>
            <div className='w-full shadow-xl bg-gray-100 flex flex-col p-4 my-8 md:my-0 rounded-lg hover:scale-105 duration-300'>
                ...
                <button className='bg-[#000300] text-[#00df9a] rounded-md w-[200px] text-center mx-auto px-6 py-3 my-6 font-medium'>Start Trial</button>
            </div>
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
